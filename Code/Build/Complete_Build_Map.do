...
*7) Merge the Stride K12 data with catchement zones and FCC data.
...
*   that is used to map total online enrollment by state over time 
do ".\Code\Figures_Summary_Stats\CCD_stride_summarystatistics.do"

*9) Map Virtual School Enrollment as a Percent of Total School Enrollment
...
do ".\Code\Figures_Summary_Stats\Stride_VS_NeighborhoodSD.do"

*11) Figure 3: Neighborhood and Virual school racial compositions 
do ".\Code\Figures_Summary_Stats\SchoolSeg.do"
...
*    14. 
do  ".\Code\Modules\formatcoefs.do"
...
* racial groups). This is done in:
do  ".\Code\Models\ModelsByRace_10252021.do"
